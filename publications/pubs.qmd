---
title: ""
pagetitle: "Sayak Khatua | Publications"
toc: true
...
::: {.paper}
[The Reliability of Replications: A Study in Computational Reproductions]{.paper-title}
[with Nate Breznau et al.]{.authors}
[[Royal Society Open Science]{.venue}]{.meta}

[ [Preprint](https://www.doi.org/10.31235/osf.io/j7qta) [Published](https://doi.org/10.1098/rsos.241038) ]{.paper-links}
...
::: {.paper}
[Power to the Researchers: Calculating Power After Estimation]{.paper-title}
[with Alex Tian, Robert Reed, Tom Coupe, and Ben Wood]{.authors}
[[Review of Development Economics]{.venue}]{.meta}

[ [Published](https://doi.org/10.1111/rode.13130) ]{.paper-links}
...
::: {.paper}
[Research Transparency and Reproducibility at the International Initiative for Impact Evaluation]{.paper-title}
[with [Sean Grant](https://education.uoregon.edu/directory/faculty/all/spgrant)]{.authors}
[[Journal of Development Effectiveness]{.venue}]{.meta}

[ [Published](https://doi.org/10.1080/19439342.2024.2388102) ]{.paper-links}
...
::: {.paper}
[Using Big Data for Evaluating Development Outcomes: A Systematic Map]{.paper-title}
[with F. Rathinam, Z. Siddiqui, M. Malik, P. Duggal, S. Watson, and X. Vollenweider]{.authors}
[[Campbell Systematic Reviews]{.venue}]{.meta}

[ [Published](https://doi.org/10.1002/cl2.1149) ]{.paper-links}
...
**Search Methods:** A number of general and specialised data bases and repositories of organisations were searched using keywords related to big data by an information specialist.
...
::: {.paper}
[Short-Term Versus Long-Term Effects of Forced Displacement]{.paper-title}
[with Vengadeshvaran Sarma]{.authors}
[[Land Acquisition in Asia]{.venue}]{.meta}

[ [Chapter](https://link.springer.com/chapter/10.1007/978-981-13-6455-6_3) ]{.paper-links}
...
::: {.paper}
[Three Ways You Can Start Using Remote Sensing for Measuring Impact]{.paper-title}
[with Aayush Malik, Douglas Glandon, Jane Hammaker, and Katherine Quant]{.authors}
[[3ie Blog]{.venue}]{.meta}

[ [Read](https://www.3ieimpact.org/blogs/three-ways-you-can-start-using-remote-sensing-measuring-impact) ]{.paper-links}
:::

::: {.paper}
[Assessing the Impact of Policy and Institutional Reforms in International Development]{.paper-title}
[with Caroline Huang, Zeba Siddiqui, Douglas Glandon, and Aayush Malik]{.authors}
[[3ie Blog]{.venue}]{.meta}

[ [Read](https://www.3ieimpact.org/blogs/assessing-impact-policy-and-institutional-reforms-international-development) ]{.paper-links}
:::
...
::: {.paper}
[Beyond Counterfactuals: Making Transparency, Reproducibility, and Ethics (TRE) Central to Rigorous Evidence Generation]{.paper-title}
[with Jennifer Sturdy]{.authors}
[[3ie Blog]{.venue}]{.meta}

[ [Read](https://www.3ieimpact.org/blogs/beyond-counterfactuals-making-transparency-reproducibility-and-ethics-tre-central-rigorous) ]{.paper-links}
:::
...
::: {.paper}
[What's the Deal with Push Button Replication?]{.paper-title}
[[3ie Blog]{.venue}]{.meta}

[ [Read](http://www.3ieimpact.org/blogs/whats-deal-push-button-replications) ]{.paper-links}
:::

::: {.paper}
[A Dialogue on Transparency, Open Access and Ethics in Development Research]{.paper-title}

[ [Event Report](https://www.3ieimpact.org/sites/default/files/2019-04/Research-transparency-3ie-event.pdf) ]{.paper-links}
:::
...
::: {.paper}
[Swachch Bharat Mission: Need Clarity on Actual Impact]{.paper-title}
[with P. V. Apoorva and Anjali Krishnan]{.authors}

[ [Read](http://bit.ly/2z1X6BI) ]{.paper-links}
:::
